...
public class CursorController : MonoBehaviour
{
    ...
    private GameObject my_controllable;
    ...
    void Start()
    {
        ...
        my_controllable = GameObject.Find("playerControllables");
    }
    private void Update()
    {
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        MySystem.Mode system_mode = my_system.GetComponent<MySystem.Status>().system_mode;
        if (system_mode != myMode) return;
        my_controllable.GetComponent<Controllables>().toBeControlled = collision.gameObject;
        // transform.position -= direction;
    }
}
